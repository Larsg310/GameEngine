...
public class Util
{
    ...
    public static String[] removeEmptyStrings(String[] data)
    {
        ...
        for (String aData : data) if (!aData.equals("")) result.add(aData);
    ...
    public static void generateNormalsCW(Vertex[] vertices, int[] indices)
    {
        for (int i = 0; i < indices.length; i += 3)
        {
            ...
            Vec3f normal = v1.substract(v0).cross(v2.substract(v0)).normalize();
        ...
        for (Vertex vertex : vertices) vertex.setNormal(vertex.getNormal().normalize());
    ...
    public static void generateNormalsCCW(Vertex[] vertices, int[] indices)
    {
        for (int i = 0; i < indices.length; i += 3)
        {
            ...
            Vec3f normal = v2.substract(v0).cross(v1.substract(v0)).normalize();
    ...
    public static void generateNormalsCW(SmoothingGroup smoothingGroup)
    {
        for (Face face : smoothingGroup.getFaces())
        {
            ...
            smoothingGroup.getVertices().get(face.getIndices()[0]).setNormal(smoothingGroup.getVertices().get(face.getIndices()[0]).getNormal().add(normal));
            smoothingGroup.getVertices().get(face.getIndices()[1]).setNormal(smoothingGroup.getVertices().get(face.getIndices()[1]).getNormal().add(normal));
            smoothingGroup.getVertices().get(face.getIndices()[2]).setNormal(smoothingGroup.getVertices().get(face.getIndices()[2]).getNormal().add(normal));
        }
        
        for (Vertex vertex : smoothingGroup.getVertices()) vertex.setNormal(vertex.getNormal().normalize());
    ...
    public static void generateTangentsBitangents(Mesh mesh)
    {
        for (int i = 0; i < mesh.getIndices().length; i += 3)
        {
            ...
            Vec3f e1 = v1.substract(v0);
            Vec3f e2 = v2.substract(v0);
            
            Vec2f deltaUV1 = uv1.substract(uv0);
            Vec2f deltaUV2 = uv2.substract(uv0);
            ...
            Vec3f normal = mesh.getVertices()[mesh.getIndices()[i]].getNormal().add(mesh.getVertices()[mesh.getIndices()[i + 1]].getNormal()).add(mesh.getVertices()[mesh.getIndices()[i + 2]].getNormal());
            normal = normal.normalize();
            
            Vec3f biTangent = tangent.cross(normal);
            
            tangent = tangent.normalize();
            biTangent = biTangent.normalize();
            
            if (mesh.getVertices()[mesh.getIndices()[i]].getTangent() == null) mesh.getVertices()[mesh.getIndices()[i]].setTangent(new Vec3f(0, 0, 0));
            if (mesh.getVertices()[mesh.getIndices()[i]].getBiTangent() == null) mesh.getVertices()[mesh.getIndices()[i]].setBiTangent(new Vec3f(0, 0, 0));
            if (mesh.getVertices()[mesh.getIndices()[i + 1]].getTangent() == null) mesh.getVertices()[mesh.getIndices()[i + 1]].setTangent(new Vec3f(0, 0, 0));
            if (mesh.getVertices()[mesh.getIndices()[i + 1]].getBiTangent() == null) mesh.getVertices()[mesh.getIndices()[i + 1]].setBiTangent(new Vec3f(0, 0, 0));
            if (mesh.getVertices()[mesh.getIndices()[i + 2]].getTangent() == null) mesh.getVertices()[mesh.getIndices()[i + 2]].setTangent(new Vec3f(0, 0, 0));
            if (mesh.getVertices()[mesh.getIndices()[i + 2]].getBiTangent() == null) mesh.getVertices()[mesh.getIndices()[i + 2]].setBiTangent(new Vec3f(0, 0, 0));
