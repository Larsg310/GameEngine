...
public class Vec3f
{
    ...
    public Vec3f substract(Vec3f r)
    {
        return new Vec3f(this.X - r.getX(), this.Y - r.getY(), this.Z - r.getZ());
    }
    
    public Vec3f substract(float r)
    {
        return new Vec3f(this.X - r, this.Y - r, this.Z - r);
    }
    
    public Vec3f multiply(Vec3f r)
    {
        return new Vec3f(this.X * r.getX(), this.Y * r.getY(), this.Z * r.getZ());
    }
    ...
    public Vec3f multiply(float r)
    {
        return new Vec3f(this.X * r, this.Y * r, this.Z * r);
    }
    
    public Vec3f divide(Vec3f r)
    {
        return new Vec3f(this.X / r.getX(), this.Y / r.getY(), this.getZ() / r.getZ());
    }
    
    public Vec3f divide(float r)
    {
        return new Vec3f(this.X / r, this.Y / r, this.Z / r);
    }
